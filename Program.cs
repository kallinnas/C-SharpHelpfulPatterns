...
class Program
{
    ...
    {
        JsonKeyAge j = new JsonKeyAge();
        LinqInts l = new LinqInts();
    ...
    //private static string ParseJSONStringAndGetProperty(string jsonString, string propertyName)
    //{
    //    string data = "";
    ...
    //        data = json.RootElement.GetProperty(propertyName).ToString();
    //    }
    ...
    //private static List<(string key, int age)> GetAllAgeStartsFrom50(List<(string key, int age)> keyAgeList)
    //{
    //    List<(string key, int age)> ageStartsFrom50List = new List<(string key, int age)>();

    //    try
    //    {
    //        foreach (var item in keyAgeList)
    //        {
    //            if (item.age >= 50)
    //            {
    //                ageStartsFrom50List.Add(item);
    //            }
    //        }
    //    }
